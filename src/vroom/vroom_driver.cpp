 ...
 * defined in the C++ Header file - `vrp_vroom.hpp`
 *
...
vrp_vroom(
        bool directed,
        int64_t max_depth) {
    pgrouting::functions::Pgr_vroom fn_vroom;
    auto results = fn_vroom.vroom(directed, max_depth);
    return results;
}
 ...
 * passes these variables to the template function `vrp_vroom`
